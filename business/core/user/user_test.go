...
import (
	...
	"github.com/mroobert/my-service/business/core/user"
	"github.com/mroobert/my-service/business/data/dbtest"
	"github.com/mroobert/my-service/business/sys/auth"
	"github.com/mroobert/my-service/foundation/docker"
)
...
func TestUser(t *testing.T) {
	...
	t.Log("Given the need to work with User records.")
	{
		...
		t.Logf("\tTest %d:\tWhen handling a single User.", testID)
		{
			...
			upd := user.UpdateUser{
				Name:  dbtest.StringPointer("Andrei Mihai"),
				Email: dbtest.StringPointer("andrei@gmail.com"),
			}
