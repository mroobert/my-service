...
// Package level variables if:
// 1. we don't need config for initializing it
// 2. initialization order does not matter before main
// 3. the only code that touches it it's the code that declares it
