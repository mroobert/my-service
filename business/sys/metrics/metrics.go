...
// inside of expvar is registered as a singleton. The use of init will make
...
// AddGoroutines increments the goroutines metric by the number that currently exists.
